...
<template>
  <div class="container py-10">
    ...
    <ul>
      ...
      <li>
        <p><strong>Country</strong> refers to: Kosovo</p>
      </li>
      <li>
        <p>
          <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to lm academy.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to lm academy, accessible from
          <a href="http:%5Clm-academy.edu" rel="external nofollow noopener" target="_blank"
            >http:\lm-academy.edu</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: lutfimusiqiacademy@gmail.com</li>
    </ul>
  </div>
</template>
